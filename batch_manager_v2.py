...
def get_table_name():
    env = opt.option().env
    return GET_CONF('meta_table', env) + '_v2'
...
def batch_v2_main():
    print clear_batch('test', '1', '2', '3', 'jpg')

    print set_batch('test', '1', '2', '3', 'jpg', '!!!')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print set_batch('test', '1', '2', '3', 'jpg', 'batch1')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print set_batch('test', '1', '2', '3', 'jpg', 'batch3')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print set_batch('test', '1', '2', '3', 'jpg', 'batch2')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print set_batch('test', '1', '2', '3', 'jpg', 'batch2')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print del_batch('test', '1', '2', '3', 'jpg', 'batch2')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')

    print del_batch('test', '1', '2', '3', 'jpg', 'batch3')
    print 'last:', get_last_batch('test', '1', '2', '3', 'jpg')
